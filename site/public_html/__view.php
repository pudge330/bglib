...
<body>
<!-- <pre><code class="language-php">class App\AppCompiler extends Lynk\Component\ApplicationCompiler\AppCompiler {
...
<div class="page d-flex flex-column">
	...
	<div class="page-footer">
		<footer class="text-center p-1"><div>&copy;2022 bglib</div></footer>
	</div>
