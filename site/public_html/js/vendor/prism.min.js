/* PrismJS 1.17.1
https://prismjs.com/download.html#themes=prism&languages=markup+css+clike+javascript+c+csharp+bash+cpp+aspnet+markup-templating+git+less+java+php+javadoclike+markdown+json+typescript+phpdoc+sql+scss+python+sass+twig+yaml+visual-basic+regex&plugins=line-highlight+line-numbers+toolbar+highlight-keywords+download-button+match-braces */
